...
def load_args():
    ...
    parser.add_argument('--cls_loss_ratio', default=1.0, type=float,
                        help='ratio for classification loss')
    parser.add_argument('--cls_loss_ratio1', default=1.0, type=float,
                        help='ratio for classification loss')
    
    # options for contrastive MAE
    parser.add_argument('--cl_temperature', default=0.8, type=float,
                        help='temperature for cl logits')    
    parser.add_argument('--cl_loss_ratio', default=1.0, type=float,
                        help='ratio for classification loss')
